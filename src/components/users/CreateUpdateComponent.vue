          ...
          <div class="row">
            <div class="card">
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-sm">
                    <label class="form-label label-title" for="docType">Tipo de Documento</label>
                    <i class="req">*</i>
                  ...
                  <div class="col-sm">
                    <label class="form-label label-title" for="doc">Documento de Identidad</label>
                    <i class="req">*</i>
                    <div class="input-group">
                      <span class="input-group-text">
                  ...
                  <div class="col-sm">
                    <label class="form-label label-title" for="username">Nombre Completo</label>
                    <i class="req">*</i>
                    <div class="input-group">
                      <span class="input-group-text">
                        <fa icon="user" />
          ...
          <div class="row mt-3">
            <div class="card">
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-sm">
                    <label class="form-label label-title" for="email">E-mail</label>
                    <i class="req">*</i>
                    <div class="input-group">
                      <span class="input-group-text">
                        <fa icon="envelope" />
                  ...
                  <div class="col-sm">
                    <label class="form-label label-title" for="phone">Celular</label>
                    <i class="req">*</i>
                    <div class="input-group">
                      <span class="input-group-text">
                  ...
                  <div class="col-sm">
                    <label class="form-label label-title" for="dir">Dirección</label>
                    <i class="req">*</i>
                    <a
                      id="infoDirPop"
                      tabindex="0"
                    ...
                    <div class="input-group">
                      ...
                      <input
                        ...
                        class="form-control"
                        id="dir"
                        placeholder="Calle 1 # 2 - 3 Apto:123"
                        autocomplete="off"
          ...
          <div class="row mt-3">
            <div class="card">
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-sm">
                    <label class="form-label label-title">Tipo de Usuario</label>
                    <i class="req">*</i>
                    <div class="input-group">
                      <span class="input-group-text">
                        <fa icon="list-alt" />
...
export default {
  ...
  methods: {
    openModal(roleId) {
      if (roleId == 4) this.parentModal.show();
      if (roleId == 3) this.coursesModal.show();
    },
    parentEvent(event) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          await this.confirmSend().then(() => {
            ...
            if (this.editUser) this.$emit("updateDone");
            else this.cleanForm();
          });
        }
      });
    ...
    async confirmSend() {
      return new Promise((resolve) => {
        if (this.editUser) UserServices.update(this.user).then(() => resolve());
        else UserServices.create(this.user).then(() => resolve());
      });
    },
    cleanForm() {
      this.user.name = "";
