                ...
                <section class="row">
                  <section class="col-sm-4">
                    ...
                    <div class="input-group">
                      <select class="form-select" id="sectionList" v-model="section.code" required
                        :disabled="editNote == true">
                        <option value="ALL" selected>Todas</option>
                        <option v-for="sect in getSections" :key="sect.code" :value="sect.code">
                          {{ sect.description }}
                        </option>
                      </select>
                    </div>
                  ...
                  <section class="col-sm-4">
                    ...
                    <div class="input-group">
                      <select class="form-select" id="courseList" v-model="course.code" required
                        :disabled="editNote == true">
                        <option value="ALL" selected>Todos</option>
                        <option v-for="cour in getCourses" :key="cour.code" :value="cour.code">
                          {{ cour.description }}
                        </option>
                      </select>
                    </div>
